...
export default function AtividadeVagas() {

  const [listarAtividade, setListarAtividade] = useState([''])

  async function ListarAtividades() {
    const response = await apiCliente.get('/ListarReuniaoVagas')
    ...
    <SafeAreaView style={styles.container}>
        ...
        <ScrollView>
          <View style={styles.reunioa}>
            <Text style={styles.reunioa1}>Segue a lista das atividade que faremos em campo ao longo do curso, 
            e anuncio de vaga de emprego</Text>
          </View>
